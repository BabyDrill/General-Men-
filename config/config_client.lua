...
Config.DoubleJob = false -- ablita se usi il doppio lavoro

Config.NoclipSpeed = 2.0 -- cambialo per cambiare la velocità in noclip

Config.JSFourIDCard = true -- abilita se stai usando jsfour-idcard
...
Config.Admin = {
	...
	},
	{
		...
		groups = {'_dev', 'owner', 'superadmin', 'admin', 'mod', 'helper'},
		command = function()
