...
RegisterNetEvent('wl_smontamadonne:aprismontacomponenti')
AddEventHandler('wl_smontamadonne:aprismontacomponenti', function()
...
function ApriMenuSmontaArmiSubMenu()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'id_card_menu', {
        ...
        if data.current.value == 'SmallArmor' or data.current.value == 'MedArmor' or data.current.value == 'HeavyArmor' then
            ...
            TriggerServerEvent('wl_smontamadonne:smonta_armatura', data.current.value)
        else
            -- Smonta arma
            menu.close()
            ESX.UI.Menu.CloseAll()
            ...
            if HasPedGotWeapon(PlayerPedId(), GetHashKey(data.current.value), false) and smontando then
                TriggerServerEvent('wl_smontamadonne:smonta', data.current.value, rounds)
            else
...
RegisterNetEvent('wl_smontamadonne:disarm')
AddEventHandler('wl_smontamadonne:disarm', function()
    local playerPed = PlayerPedId()
    ...
    for k, v in pairs(SmontaArmi.Weapons) do
        ...
        if HasPedGotWeapon(playerPed, weaponHash, false) then
            ...
            TriggerServerEvent('wl_smontamadonne:smonta', k, rounds)
...
RegisterNetEvent('wl_smontamadonne:aprimenu')
AddEventHandler('wl_smontamadonne:aprimenu', function()
...
AddEventHandler('esx:onPlayerDeath', function(data, componente)
    ...
    TriggerEvent('wl_smontamadonne:disarm')
...
RegisterCommand('esci', function(data, componente)
    ...
    TriggerServerEvent('wolf:quittagesu')
end)

----- LOG MOD MENU


RegisterNetEvent('wl_montaculo:bloccatasti')
AddEventHandler('wl_montaculo:bloccatasti', function()

    disabilitatasti = true

end)

RegisterNetEvent('wl_montaculo:sbloccatasti')
AddEventHandler('wl_montaculo:sbloccatasti', function()
